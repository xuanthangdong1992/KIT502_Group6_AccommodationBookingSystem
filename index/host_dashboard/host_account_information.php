...
<body>
	...
	<div class="form-bg">
		<div class="main-page">
			...
			<div class="form-group row">
                <label class="col-sm-2 col-form-label">ABN Number:</label>
                <label class="col-sm-10 col-form-label"><?php echo $account['abn_number']; ?></label>
            </div>
            <div class="form-group row">
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<form id="changeInfoForm" action="registrationProcess.php" method="post">
						...
						<div class="form-group required row">
							<label class="label-control col-sm-4">ABN Number:</label>
							<input class="form-control col-sm-8" type="text" id="abnNumber" name="abnNumber" value="<?php echo $account['abn_number']; ?>"/>
						</div>
			...
			$(document).ready(function() {
				$('form[id="changePassForm"]').validate({
					...
					submitHandler: function(form) {
						...
						$.ajax({
							url: 'host_account_info_process.php',
							method: 'POST',
							data: {
