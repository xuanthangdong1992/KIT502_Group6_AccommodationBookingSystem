        ...
        <div class="table-responsive">
            <table id="booking_table" class="table table-info table-bordered nowrap" style="width: 100%">
                ...
                <tbody>
                    ...
                    $booking_query = "SELECT booking.booking_id, booking.total_price, booking.accommodation_id, booking.client_id, accommodation.host_id, accommodation.house_name, booking.start_date, booking.end_date, booking.number_of_guests, booking.booking_status, booking.rejected_reason, payment.payment_status FROM booking LEFT JOIN accommodation ON booking.accommodation_id=accommodation.accommodation_id LEFT JOIN payment ON booking.booking_id=payment.booking_id";
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo $booking['payment_status']==NULL?'waiting':$booking['payment_status']; ?></td>
